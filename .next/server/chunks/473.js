"use strict";exports.id=473,exports.ids=[473],exports.modules={24934:(e,a,t)=>{t.d(a,{$:()=>c});var i=t(60687),n=t(43210),s=t(8730),o=t(24224),r=t(96241);let l=(0,o.F)("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 shadow-sm [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",{variants:{variant:{default:"bg-primary text-primary-foreground hover:bg-primary/90 shadow-md",destructive:"bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-md",outline:"border-2 border-primary text-primary bg-background hover:bg-primary hover:text-primary-foreground hover:border-black dark:hover:border-white shadow-md",secondary:"bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-md",ghost:"hover:bg-accent hover:text-accent-foreground",link:"text-primary underline-offset-4 hover:underline"},size:{default:"h-10 px-4 py-2",sm:"h-9 rounded-md px-3",lg:"h-11 rounded-md px-8",icon:"h-10 w-10"}},defaultVariants:{variant:"default",size:"default"}}),c=n.forwardRef(({className:e,variant:a,size:t,asChild:n=!1,...o},c)=>{let d=n?s.DX:"button";return(0,i.jsx)(d,{className:(0,r.cn)(l({variant:a,size:t,className:e})),ref:c,...o})});c.displayName="Button"},58478:(e,a,t)=>{t.d(a,{A:()=>u});var i=t(60687),n=t(43210),s=t(24934),o=t(85814),r=t.n(o),l=t(33525),c=t(16189),d=t(33270);function h({isOpen:e,onClose:a}){let{getHeadingClass:t,getBodyClass:n}=(0,l.DP)(),o=(0,c.usePathname)(),{user:h}=(0,d.A)();return(0,i.jsxs)("div",{className:`fixed inset-0 z-50 lg:hidden transition-all duration-300 ${e?"pointer-events-auto":"pointer-events-none"}`,"aria-modal":"true",role:"dialog",children:[(0,i.jsx)("div",{className:`absolute inset-0 bg-black transition-opacity duration-300 ${e?"opacity-50":"opacity-0"}`,onClick:a}),(0,i.jsxs)("div",{className:`fixed inset-y-0 right-0 w-4/5 max-w-xs bg-card shadow-xl flex flex-col h-full transform transition-transform duration-300 ${e?"translate-x-0":"translate-x-full"}`,children:[(0,i.jsxs)("div",{className:"flex items-center justify-between p-4 border-b border-border",children:[(0,i.jsx)("span",{className:`font-bold text-lg ${t()}`,children:"Menu"}),(0,i.jsx)(s.$,{variant:"ghost",size:"icon",onClick:a,className:"text-foreground",children:(0,i.jsx)("span",{className:"material-symbols-outlined",children:"close"})})]}),(0,i.jsxs)("nav",{className:"flex-1 overflow-y-auto flex flex-col p-4 space-y-2",children:[(0,i.jsx)(r(),{href:"/",className:`p-3 text-base rounded-md transition-colors ${"/"===o?"font-semibold bg-accent":"hover:bg-accent"} ${n()}`,onClick:a,children:"Home"}),(0,i.jsx)(r(),{href:"/about",className:`p-3 text-base rounded-md transition-colors ${"/about"===o?"font-semibold bg-accent":"hover:bg-accent"} ${n()}`,onClick:a,children:"About"}),(0,i.jsx)(r(),{href:"/blog",className:`p-3 text-base rounded-md transition-colors ${o.startsWith("/blog")?"font-semibold bg-accent":"hover:bg-accent"} ${n()}`,onClick:a,children:"Blog"}),(0,i.jsx)(r(),{href:"/faq",className:`p-3 text-base rounded-md transition-colors ${"/faq"===o?"font-semibold bg-accent":"hover:bg-accent"} ${n()}`,onClick:a,children:"FAQ"}),(0,i.jsx)(r(),{href:"/services",className:`p-3 text-base rounded-md transition-colors ${"/services"===o?"font-semibold bg-accent":"hover:bg-accent"} ${n()}`,onClick:a,children:"Services"}),(0,i.jsx)(r(),{href:"/contact",className:`p-3 text-base rounded-md transition-colors ${"/contact"===o?"font-semibold bg-accent":"hover:bg-accent"} ${n()}`,onClick:a,children:"Contact"}),h&&(0,i.jsx)(r(),{href:"/admin",className:`p-3 text-base rounded-md transition-colors ${o.startsWith("/admin")?"font-semibold bg-accent":"hover:bg-accent"} ${n()}`,onClick:a,children:"Admin"})]})]})]})}function u(){let{getHeadingClass:e,getBodyClass:a}=(0,l.DP)(),[t,o]=(0,n.useState)(!1),{user:c}=(0,d.A)();return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("header",{className:"border-b border-border bg-card sticky top-0 z-40 shadow-sm",children:(0,i.jsxs)("div",{className:"container mx-auto px-6 h-16 flex items-center justify-between",children:[(0,i.jsx)(r(),{href:"/",className:"flex items-center space-x-2",children:(0,i.jsx)("span",{className:`text-lg font-bold text-foreground ${e()}`,children:"Dr Salumu"})}),(0,i.jsxs)("nav",{className:"hidden md:flex items-center space-x-6",children:[(0,i.jsx)(r(),{href:"/",className:`text-sm font-medium hover:text-foreground/70 transition-colors ${a()}`,children:"Home"}),(0,i.jsx)(r(),{href:"/about",className:`text-sm font-medium hover:text-foreground/70 transition-colors ${a()}`,children:"About"}),(0,i.jsx)(r(),{href:"/services",className:`text-sm font-medium hover:text-foreground/70 transition-colors ${a()}`,children:"Services"}),(0,i.jsx)(r(),{href:"/blog",className:`text-sm font-medium hover:text-foreground/70 transition-colors ${a()}`,children:"Blog"}),(0,i.jsx)(r(),{href:"/faq",className:`text-sm font-medium hover:text-foreground/70 transition-colors ${a()}`,children:"FAQ"}),(0,i.jsx)(r(),{href:"/contact",className:`text-sm font-medium hover:text-foreground/70 transition-colors ${a()}`,children:"Contact"}),c&&(0,i.jsx)(r(),{href:"/admin",className:`text-sm font-medium hover:text-foreground/70 transition-colors ${a()}`,children:"Admin"})]}),(0,i.jsx)(s.$,{variant:"ghost",size:"sm",className:"md:hidden shadow-none",onClick:()=>o(!0),children:(0,i.jsx)("span",{className:"material-symbols-outlined text-base",style:{fontSize:"20px"},children:"menu"})})]})}),(0,i.jsx)(h,{isOpen:t,onClose:()=>o(!1)})]})}},60544:(e,a,t)=>{t.d(a,{GH:()=>s,KB:()=>n});let i=[{question:"What services does Dr. Salumu offer?",answer:"We offer general medical consultations, preventative care, chronic illness management, and more."},{question:"Do I need an appointment?",answer:"Appointments are preferred but we do accept walk-ins when possible."},{question:"Where is the practice located?",answer:"14 Central Avenue, Kempton Park, Gauteng, South Africa."}];async function n(){return Promise.resolve(i)}async function s(){return await new Promise(e=>setTimeout(e,500)),[{id:"heart-health-basics",title:"Heart Health: Your Guide to a Stronger Heart",summary:"Learn essential tips for maintaining heart health through diet, exercise, and lifestyle changes. Discover warning signs and when to seek medical attention.",content:`Heart health is fundamental to overall well-being. Your heart works tirelessly, pumping blood throughout your body to deliver oxygen and nutrients to every cell. Taking care of this vital organ should be a top priority.
...
Remember, small changes can make a big difference in heart health. Start with one improvement and build from there. Your heart will thank you for it!`,category:"Heart Health",date:"2024-01-15",author:"Dr. Kabongo Salumu",readTime:"5 min read",tags:["heart health","cardiovascular","prevention","lifestyle"]},{id:"mental-wellness-guide",title:"Mental Wellness: Building Resilience in Daily Life",summary:"Explore practical strategies for maintaining mental health, managing stress, and building emotional resilience in today's fast-paced world.",content:`Mental wellness is just as important as physical health, yet it's often overlooked. In our busy lives, taking time to care for our mental health is essential for overall well-being and quality of life.
...
Remember, mental wellness is a journey, not a destination. Be patient with yourself and celebrate small progress. Your mental health matters, and taking care of it is one of the most important things you can do for yourself and those around you.`,category:"Mental Wellness",date:"2024-01-10",author:"Dr. Kabongo Salumu",readTime:"6 min read",tags:["mental health","wellness","stress management","resilience"]},{id:"vaccination-importance",title:"Vaccinations: Protecting Your Family's Health",summary:"Understand the importance of vaccinations, common myths debunked, and the vaccination schedule for different age groups in South Africa.",content:`Vaccinations are one of the most effective ways to prevent serious diseases and protect public health. They work by training your immune system to recognize and fight specific infections.
...
Vaccination is a simple, safe, and effective way to protect your health and contribute to public health. Talk to your healthcare provider about which vaccines you and your family need.`,category:"Vaccinations",date:"2024-01-05",author:"Dr. Kabongo Salumu",readTime:"7 min read",tags:["vaccinations","immunization","public health","prevention"]},{id:"child-health-essentials",title:"Child Health: Essential Care for Growing Families",summary:"Comprehensive guide to child health, from newborn care to adolescent development, including nutrition, safety, and when to seek medical attention.",content:`Raising healthy children is one of life's most important responsibilities. Understanding child health basics helps parents make informed decisions and provide the best care for their children.
...
Remember, every child develops at their own pace. Trust your instincts as a parent, and don't hesitate to ask your healthcare provider questions. Your child's health and well-being are worth the attention and care you provide.`,category:"Child Health",date:"2024-01-20",author:"Dr. Kabongo Salumu",readTime:"8 min read",tags:["child health","pediatrics","development","parenting"]},{id:"diabetes-management",title:"Diabetes Management: Living Well with Diabetes",summary:"Comprehensive guide to managing diabetes through diet, exercise, medication, and lifestyle changes. Learn about prevention and treatment options.",content:`Diabetes is a chronic condition that affects how your body processes glucose (sugar). With proper management, people with diabetes can live healthy, active lives.
...
Remember, diabetes management is a journey, not a destination. With proper care, education, and support, you can live a full, healthy life with diabetes. Work closely with your healthcare team and don't hesitate to ask questions or seek help when needed.`,category:"Chronic Conditions",date:"2024-01-25",author:"Dr. Kabongo Salumu",readTime:"9 min read",tags:["diabetes","chronic disease","management","lifestyle"]},{id:"preventive-care-guide",title:"Preventive Care: Your Health Investment",summary:"Learn about the importance of preventive healthcare, recommended screenings by age, and how regular check-ups can prevent serious health issues.",content:`Preventive care is the foundation of good health. By taking proactive steps to maintain your health and catch potential problems early, you can avoid serious illnesses and enjoy a better quality of life.
...
Remember, preventive care is an investment in your future health and well-being. The time and effort you put into prevention today can save you from serious health problems tomorrow. Work with your healthcare provider to develop a personalized preventive care plan that fits your needs and lifestyle.`,category:"Preventive Care",date:"2024-01-30",author:"Dr. Kabongo Salumu",readTime:"10 min read",tags:["preventive care","screenings","vaccinations","lifestyle"]}]}},96241:(e,a,t)=>{t.d(a,{cn:()=>s});var i=t(49384),n=t(82348);function s(...e){return(0,n.QP)((0,i.$)(e))}}};